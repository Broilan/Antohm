...
const PostPage = () => {
  ...
  return (
    ...
    <div className='w-screen flex flex-col items-center'>
        ...
        {foundPost? <Post pfp={foundPost.UserID.pfp} postID={params.id} posterID={foundPost.UserID._id} username={foundPost.UserID.name} displayName={foundPost.UserID.displayName} bookmarks={foundPost.bookmarks} comments={foundPost.comments} likes={foundPost.likes} datePosted={foundPost.date} content={foundPost.content} sourced={foundPost.sourced} /> :null }
        ...
        {foundComments?.map((c) => <Comment pfp={c.commentFrom.pfp} from={c.commentFrom} to={c.commentTo} comments={c.comments} content={c.content} likes={c.likes} postID={c.postID} /> )}
        </div>
    </div>
